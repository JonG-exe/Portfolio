    ...
    function iconHover() {
        ...
        for(let i = 0; i < icons.length; i++) {
            ...
            icons[i].addEventListener("mouseover", () => {
                ...
                // if(icons[i].name === "javascript"){
                //     selectedIcon.style.color = "black"
                //     selectedIcon.style.fontWeight = "900"
                // }
                // else {
                //     selectedIcon.style.color = "white"
                //     selectedIcon.style.fontWeight = "500"
                // }
        ...
        <div className={props.className}>
            ...
            {props.className === "infoTile infoTile_three" 
                ...
                <div className="icon-container">
                    ...
                    <img className="icon-image" src={image_one} name="html5"/>
                    <img className="icon-image" src={image_two} name="css3" />
                    <img className="icon-image" src={image_three} name="javascript" />
                    <img className="icon-image" src={image_four} name="mongodb" />
                    <img className="icon-image" src={image_five} name="react" />
                    <img className="icon-image" src={image_six} name="adobexd" />
